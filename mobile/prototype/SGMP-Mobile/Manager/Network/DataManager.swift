...
//        let requestData = AnalyticsAggregatedRequest(start_time: UInt64(startDate.timeIntervalSince1970 * 1000), end_time: UInt64(endDate.timeIntervalSince1970 * 1000), formula: formula, agg_function: aggregateFunction)
...
//        let requestData = AnalyticsAggregatedRequest(start_time: UInt64(startDate.timeIntervalSince1970 * 1000), end_time: UInt64(endDate.timeIntervalSince1970 * 1000), formula: "\(deviceName).\(key)", agg_function: aggregateFunction)
//        var request = URLRequest(url: SgmpHostUrl.appendingPathComponent("api/data/read"))
//        request.httpMethod = "POST"
//        request.setValue("application/json", forHTTPHeaderField: "content-type")
//        do {
...
//        let requestData = AnalyticsTimeSeriesRequest(start_time: UInt64(startDate.timeIntervalSince1970 * 1000), end_time: UInt64(endDate.timeIntervalSince1970 * 1000), formula: "\(deviceName).\(key)")
//        var request = URLRequest(url: SgmpHostUrl.appendingPathComponent("api/data/read"))
//        request.httpMethod = "POST"
//        request.setValue("application/json", forHTTPHeaderField: "content-type")
//        do {
