export default Object.freeze({
    ...
    formula: Object.freeze({ Solar: "egauge.A.Solar", Battery: "sonnen.status.Pac_total_W/1000", BatteryCharging: "-neg(sonnen.status.Pac_total_W/1000)", BatteryDischarging: "pos(sonnen.status.Pac_total_W/1000)", SOC: "sonnen.battery.battery_status.relativestateofcharge", EV: "-egauge.A.EV", Load: "egauge.A.SubPanel", }),
